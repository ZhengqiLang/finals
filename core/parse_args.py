...
def parse_arguments(linfty, datetime, cwd):
    ...
    parser.add_argument('--mesh_verify_grid_init', type=float, default=0.04,
    ...
    ### LEARNER ARGUMENTS
    parser.add_argument('--cegis_iterations', type=int, default=3000,
                        help="Number of CEGIS iteration to run")
    parser.add_argument('--epochs', type=int, default=25,
                        help="Number of epochs to run in each iteration")
    parser.add_argument('--num_samples_per_epoch', type=int, default=1,
    ...
    parser.add_argument("--distance_weights", type=float,nargs="+",default=[1.0,1.0])
    # local_weight_type
    parser.add_argument("--local_weight_type",type=str,default="inverse")
    parser.add_argument("--local_samples_per_center",type=int,default=5)
    parser.add_argument("--local_gaussian_sigma_scale",type=float,default=0.1)
    ...
    if args.mesh_loss != 0 and args.tauK_loss != 0:
        ...
        print('Error: mesh_loss and tauK_lossff are both unspecified (specify one of them and try again).')
        sys.exit()
