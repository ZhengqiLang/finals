...
class Learner:
    ...
    def __init__(self, env, args):
        ...
        self.local_samples_per_center = int(getattr(args, "local_samples_per_center", 20))
        ...
        self.local_distance_type = getattr(args, "distance_type", "l2")
        self.local_distance_weight = jnp.array(getattr(args, "distance_weights", [1.0] * env.state_dim), dtype=jnp.float32)
